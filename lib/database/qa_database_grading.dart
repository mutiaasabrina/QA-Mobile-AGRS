  ...
  Future _createDB(Database db, int version) async {
    await db.execute('''
      CREATE TABLE qa_grading_samples (
        ...
        bjr_buah_a_mentah DOUBLE,
        buah_b_mentah DOUBLE,
        bjr_buah_b_mentah DOUBLE,
        buah_c_mentah DOUBLE,
        bjr_buah_c_mentah DOUBLE,
        buah_d_mentah DOUBLE,
        bjr_buah_d_mentah DOUBLE,
        buah_a_matang DOUBLE,
        bjr_buah_a_matang DOUBLE,
        buah_b_matang DOUBLE,
        bjr_buah_b_matang DOUBLE,
        buah_c_matang DOUBLE,
        bjr_buah_c_matang DOUBLE,
        buah_d_matang DOUBLE,
        bjr_buah_d_matang DOUBLE,
